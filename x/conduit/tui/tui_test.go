...
// PropertiesEvent handling in tui.go (which now converts
// PropertyOpDelete into the deletions slice), this pins the end-to-end
// delete path required by issue #531.
